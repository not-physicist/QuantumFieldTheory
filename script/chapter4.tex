...
\begin{align*}
	...
	\contraction{\langle}{\pmb{p}}{|\;}{\phi} \bra{\pmb{p}}\phi(x)  &= e^{+ipx}\ket{0} %%% TODO diagrams
\end{align*}
	...
	F &= \sqrt{(p_A\cdot p_B)^2 - m_A^2 m_B^2} = \frac{1}{2} \lambda^{\frac{1}{2}}(s,m^2_A,m^2_B) = \sqrt{s} |\pmb{p}_i| \\
	  &\qquad \left[ \begin{array}{ll}
			  \lambda (s,m_A^2, m_B^2) &= s^2 -2s(m_A^2 + m_B^2)-(m_A^2 - m_B^2)^2 =  (s - (m_A + m_B)^2)(s - (m_A - m_B)^2) \\
									   ...
									   &\quad \left[ 
					   \begin{array}{ll}
						   p_A = (\frac{\sqrt{s}}{2}, \pmb{p}_i) &\rightarrow m^2_A = \frac{s}{4} - |\pmb{p}_i|^2 \\
						   p_B = (\frac{\sqrt{s}}{2}, -\pmb{p}_i) &\rightarrow m^2_B = \frac{s}{4} - |\pmb{p}_i|^2
						\end{array}
						\right] \\
